        ...
        <div class="main-sidebar">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="Dashboard"><img src="{{URL::asset('images/sukaii_logo.PNG')}}" height="50px" width="180px"
                                             alt="Logo"></a>
                </div>
                <div class="sidebar-brand sidebar-brand-sm">
                    <a href="Dashboard"><img src="{{URL::asset('images/sukaii_logo.PNG')}}" height="20px" width="50px"
                                             alt="Logo"></a>
                </div>
                <ul class="sidebar-menu">
                    ...
                    <li class="nav-link"><a class="nav-item" href="orders_list"><i class="fas fa-file-prescription"></i>
                            <span>Order Details</span></a></li>

                    <li class="nav-link">
                        <a href="patient_list" class="nav-item"><i class="fas fa-user-injured"></i>

            ...
            <ul class="d-flex float-right list-unstyled mb-2">
                @if(session()->has('name'))
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                                            class="nav-link dropdown-toggle text-dark nav-link-lg nav-link-user">
                ...
                @else
                    <li class="login_row_list px-3" style="margin-top: 8px;"><a
                            style="color: #e9088a;text-decoration: none;font-weight: 600" href="{{URL::to('login')}}">Login/Signup</a>
                    </li>
                @endif
                <li class="login_row_list align-items-baseline d-flex"><span class="p-2"><i

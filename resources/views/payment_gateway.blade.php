                        ...
                        <div class="tab-content">
                            ...
                            <div id="credit-card" class="tab-pane fade show active  pt-3">
                                <form role="form" onsubmit="event.preventDefault()">
                                    ...
                                    <a href="invoice">
                                        <div class="card-footer"> <button type="button" class="subscribe btn btn-info btn-block shadow-sm"> Confirm Payment </button></a>
                                </form>
                                </div>
                            </div>
                            <!-- End -->
                            ...
                            <div id="paypal" class="tab-pane fade pt-3">
                                ...
                                <p> <button type="button" class="btn btn-info border-0"><i class="fab fa-paypal mr-2"></i> Log into my Paypal</button> </p>
                            ...
                            <div id="net-banking" class="tab-pane fade pt-3">
                                ...
                                <div class="form-group">
                                    <p> <button type="button" class="btn btn-info "><i class="fas fa-mobile-alt mr-2"></i> Proceed Payment</button> </p>
                                </div>
                                <p class="text-muted">Note: After clicking on the button, you will be directed to a secure gateway for payment. After completing the payment process, you will be redirected back to the website to view details of your order. </p>
                            </div>
                            <!-- End -->

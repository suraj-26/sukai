                ...
                <div id="card_header" class="card-header">
                            ...
                            <form role="form" onsubmit="event.preventDefault()">
                                ...
                                <a href="invoice">
                                    <div class="card-footer">
                                        <button type="button" class="subscribe btn btn-info btn-block shadow-sm">
                                            Confirm Payment
                                        </button>
                                </a>
                            </form>
                    ...
                    <div id="paypal" class="tab-pane fade pt-3">
                        ...
                        <div class="form-group "><label class="radio-inline"> <input type="radio" name="optradio"
                                                                                     checked> Domestic </label>
                            <label class="radio-inline"> <input type="radio" name="optradio" class="ml-5">International
                            </label></div>
                        <p>
                            <button type="button" class="btn btn-info border-0"><i class="fab fa-paypal mr-2"></i>
                                Log into my Paypal
                            </button>
                        </p>
                    ...
                    <div id="net-banking" class="tab-pane fade pt-3">
                        ...
                        <div class="form-group">
                            <p>
                                <button type="button" class="btn btn-info "><i class="fas fa-mobile-alt mr-2"></i>
                                    Proceed Payment
                                </button>
                            </p>
                        </div>
